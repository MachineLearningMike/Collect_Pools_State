...
def main():
    ...
    for chain in chain_id_list:
        for pool in pool_id_list:
            exec(f"{chain}_{pool}_thread = threading.Thread(target=delete_table, args =('nice-proposal-338510', 'nice-proposal-338510.Stake_event_logs.tbl_{chain}_stk'))")
